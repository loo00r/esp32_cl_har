...
use esp32_cl_har::model::{
    simple_checksum32, BASELINE_CLASSIFIER_ARTIFACT, BASELINE_CLASSIFIER_MODEL_BYTES,
    CLASSIFIER_OUTPUT_SCALE, CLASSIFIER_OUTPUT_SHAPE, CLASSIFIER_OUTPUT_ZERO_POINT,
    FEATURE_EXTRACTOR_ARTIFACT, FEATURE_EXTRACTOR_MODEL_BYTES, FEATURE_OUTPUT_SCALE,
    FEATURE_OUTPUT_SHAPE, FEATURE_OUTPUT_ZERO_POINT, MODEL_INPUT_SCALE, MODEL_INPUT_SHAPE,
