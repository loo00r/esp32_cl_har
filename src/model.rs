...
pub const MICROFLOW32_FEATURE_TENSOR_SIZE: usize = 32;
...
pub const MICROFLOW32_FEATURE_OUTPUT_SHAPE: [usize; 4] = [1, 1, 1, MICROFLOW32_FEATURE_TENSOR_SIZE];
...
pub const MICROFLOW32_FEATURE_OUTPUT_SCALE: f32 = 0.073_240_92;
pub const MICROFLOW32_FEATURE_OUTPUT_ZERO_POINT: i32 = -128;
...
pub static MICROFLOW32_FEATURE_EXTRACTOR_MODEL_BYTES: &[u8] =
    include_bytes!("model_artifacts/microflow_fullconv32_feature_extractor_int8.tflite");
